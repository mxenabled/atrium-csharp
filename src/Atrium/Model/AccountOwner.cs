...
namespace Atrium.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountOwner :  IEquatable<AccountOwner>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AccountOwner);
        }

        /// <summary>
        /// Returns true if AccountOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountOwner input)
        {
            if (input == null)
                return false;
