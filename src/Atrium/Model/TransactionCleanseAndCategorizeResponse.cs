...
namespace Atrium.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransactionCleanseAndCategorizeResponse :  IEquatable<TransactionCleanseAndCategorizeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionCleanseAndCategorizeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public TransactionCleanseAndCategorizeResponse()
        {
        }
        ...
        {
            return this.Equals(input as TransactionCleanseAndCategorizeResponse);
        }

        /// <summary>
        /// Returns true if TransactionCleanseAndCategorizeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionCleanseAndCategorizeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionCleanseAndCategorizeResponse input)
        {
            if (input == null)
                return false;
