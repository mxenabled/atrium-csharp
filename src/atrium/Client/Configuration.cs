...
namespace Atrium.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "MX-Codegen/1.10.7/csharp";
        ...
        public Configuration(
            ...
            string basePath = "https://vestibule.mx.com") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "MX-Codegen/1.10.7/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    SDK Package Version: 1.10.7\n";
