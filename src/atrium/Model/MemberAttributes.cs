...
namespace atrium.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MemberAttributes :  IEquatable<MemberAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public MemberAttributes(string identifier = default(string), string institutionCode = default(string), string metadata = default(string))
        {
        ...
        {
            return this.Equals(input as MemberAttributes);
        }

        /// <summary>
        /// Returns true if MemberAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of MemberAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemberAttributes input)
        {
            if (input == null)
                return false;
