...
namespace atrium.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MemberConnectionStatusAttributes :  IEquatable<MemberConnectionStatusAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MemberConnectionStatusAttributes);
        }

        /// <summary>
        /// Returns true if MemberConnectionStatusAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of MemberConnectionStatusAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemberConnectionStatusAttributes input)
        {
            if (input == null)
                return false;
