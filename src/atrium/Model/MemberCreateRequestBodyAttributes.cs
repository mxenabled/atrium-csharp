...
namespace Atrium.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MemberCreateRequestBodyAttributes :  IEquatable<MemberCreateRequestBodyAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberCreateRequestBodyAttributes" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MemberCreateRequestBodyAttributes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberCreateRequestBodyAttributes" /> class.
        /// </summary>
        ...
        public MemberCreateRequestBodyAttributes(List<CredentialResponseAttributes> credentials = default(List<CredentialResponseAttributes>), string identifier = default(string), string institutionCode = default(string), string metadata = default(string))
        {
            ...
            if (credentials == null)
            {
                throw new InvalidDataException("credentials is a required property for MemberCreateRequestBodyAttributes and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("institutionCode is a required property for MemberCreateRequestBodyAttributes and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as MemberCreateRequestBodyAttributes);
        }

        /// <summary>
        /// Returns true if MemberCreateRequestBodyAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of MemberCreateRequestBodyAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemberCreateRequestBodyAttributes input)
        {
            if (input == null)
                return false;
